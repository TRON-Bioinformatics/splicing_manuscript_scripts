...
```
cd existing_repo
git remote add origin https://gitlab.rlp.net/tron/splicing_manuscript_shell_scripts.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.rlp.net/tron/splicing_manuscript_shell_scripts/-/settings/integrations)
